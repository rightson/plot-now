...
router.get('/api/v1/coordinates', controllers.coordinate_api.list)
router.post('/api/v1/coordinates', controllers.coordinate_api.create)
router.get('/api/v1/coordinates/:id', controllers.coordinate_api.read)
router.put('/api/v1/coordinates/:id', controllers.coordinate_api.update)
router.del('/api/v1/coordinates/:id', controllers.coordinate_api.remove)
